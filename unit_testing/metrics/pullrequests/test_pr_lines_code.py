...
class TestPRLinesCode(TestCase):
    def setUp(self):
        # Seting the TOKEN
    ...
    def test_run_query_success(self):
        ...
        # Calling Method
        result = PRLinesCode.get_pr_lines_code_in_period(startdate,enddate)
        # Assert data
    ...
    def test_run_query_failure(self):
        ...
        with mock.patch('requests.post') as mock_test:
            ...
            with self.assertRaises(Exception) as context:
                PRLinesCode.get_pr_lines_code_in_period(startdate,enddate)
