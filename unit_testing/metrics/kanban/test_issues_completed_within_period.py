...
class TestIssuesCompletedWithinPeriod(TestCase):
    def setUp(self):
        # Seting the TOKEN
    ...
    def test_run_query_success(self):
        ...
        # Calling Method
        result = IssuesCompletedWithinPeriod.get_number_issues_completed_within_period(startdate,enddate)
        # Assert data
    ...
    def test_run_query_failure(self):
        ...
        with mock.patch('requests.post') as mock_test:
            ...
            with self.assertRaises(Exception) as context:
                IssuesCompletedWithinPeriod.get_number_issues_completed_within_period(startdate,enddate)
