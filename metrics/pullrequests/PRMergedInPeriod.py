...
def get_pr_lead_time_in_period(start_date, end_date):
    ...
    for pr_node in pull_requests:
        ...
        if pr_merged_at != None:
            ...
            date_merged_without_time = datetime(year= date_merged.year, month=date_merged.month, day=date_merged.day)

            if (date_merged_without_time >= start_date and date_merged_without_time <= end_date):
                total_pr_merged += 1
